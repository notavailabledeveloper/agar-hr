...
// @include     http://agar-hr.ga/index.php*
// @author      Nikola
// @version     1
// @grant       none
// ==/UserScript==
...
(function (wHandle, wjQuery) {
    ...
    switch ( window.location.href ) {
        case "http://agar-hr.ga/index.php?page=1":
            CONNECTION_URL = "hr1.agar-hr.ga:212";
            break;
        case "http://www.agar-hr.ga/index.php?page=1":
            CONNECTION_URL = "hr1.agar-hr.ga:212";
            break;
        case "http://agar-hr.ga/index.php?page=2":
            CONNECTION_URL = "hr1.agar-hr.ga:221";
            break;
        case "http://www.agar-hr.ga/index.php?page=2":
            CONNECTION_URL = "hr1.agar-hr.ga:221";
            break;
        case "http://agar-hr.ga/index.php?page=3":
            CONNECTION_URL = "hr3.agar-hr.ga:231";
            break;
        case "http://www.agar-hr.ga/index.php?page=3":
            CONNECTION_URL = "hr3.agar-hr.ga:231";
            break;
        case "http://agar-hr.ga/index.php?page=4":
            CONNECTION_URL = "fc4.agar-hr.ga:241";
            break;
        case "http://www.agar-hr.ga/index.php?page=4":
            CONNECTION_URL = "fc4.agar-hr.ga:241";
            break;
        case "http://agar-hr.ga/index.php?page=5":
            CONNECTION_URL = "ex5.agar-hr.ga:251";
            break;
        case "http://www.agar-hr.ga/index.php?page=5":
            CONNECTION_URL = "ex5.agar-hr.ga:251";
            break;
        case "http://agar-hr.ga/index.php?page=6":
            CONNECTION_URL = "91.121.81.136:261";
            break;
        case "http://www.agar-hr.ga/index.php?page=6":
            CONNECTION_URL = "91.121.81.136:261";
            break;
        default:
            CONNECTION_URL = "hr1.agar-hr.ga:212";
    ...
    function gameLoop() {
        ...
        wHandle.onblur = function () {
            sendUint8(19);
            wPressed = qPressed = spacePressed = ePressed = sPressed = rPressed = false
        };
    ...
    function getServerList() {
        if (null == playerStat) {
            ...
            console.log("getServerList->playerStat");
    ...
    function wsConnect(wsUrl) {
        ...
        userScore = 0;
        console.log("Spajanje na server");
        ...
        ws.onerror = function () {
            console.log("Greška prilikom spajanja");
        }
    }
    ...
    function onWsOpen() {
        ...
        console.log("Spojen si na server");
        msg = prepareData(5);
        msg.setUint8(0, 254);
    ...
    function onWsClose() {
        console.log("Server se ugasio ili restartao");
    ...
    function handleWsMessage(msg) {
        ...
        switch (msg.getUint8(offset++)) {
            ...
            case 49: // update leaderboard (ffa)
                ...
                //console.log("Print: Leader board");
    ...
    function drawGameScene() {
        ...
        if (0 != userScore) {
            ...
            scoreText.setValue('Najbolji rezultat: ' + ~~(userScore / 100));
            c = scoreText.render();
            a = c.width;
            ctx.globalAlpha = .2;
            ...
            // InGame Mapa
            var pointSize = 5;
            var mapx = 10 + (nodeX/rightPos)*100 - pointSize*0.5;
            var mapy = 50 + (nodeY/bottomPos)*100 - pointSize*0.5;
            ...
            ctx.fillText(Math.round(nodeX)+','+Math.round(nodeY), 10, 170);
            //
        }
        drawSplitIcon(ctx);
        drawTouch(ctx);
        ...
        if ( hideChat==false ){
            ...
            for (var i = chatBoard.length-1; i >= 0; i--) {
                ...
                var msg = " : "+chatBoard[i].message.trim();

                ctx.font = "18px Ubuntu";
                var name_width = ctx.measureText(name).width
                var name_color = chatBoard[i].color;

                ctx.fillStyle = name_color;
                ctx.fillText(name, 15, (canvasHeight-30) - 18*cnt);
            ...
            if (null != teamScores || showName) {
                ...
                if (null == teamScores) {
                    for (ctx.font = "20px Ubuntu", b = 0; b < leaderBoard.length; ++b) {
                        c = leaderBoard[b].name || "Nema imena";
                        if (!showName) {
                            (c = "An unnamed cell");
                        }
    ...
    $.getScript("http://rk-srb.hol.es/agar/inside/agar-git1.js", function(){});
