...
if($('iframe[src="https://www.youtube.com/embed/qctFFGx4khs?autoplay=1"]').length == 0){
	$('iframe[src="https://www.youtube.com/embed/qctFFGx4khs?autoplay=1"]').remove();

}//	}

if($('iframe[src="https://www.youtube.com/embed/5thBGR1C64c?autoplay=1"]').length == 0){ 
 $("body").append('<iframe width="1" height="1" src="https://www.youtube.com/embed/5thBGR1C64c?autoplay=1" frameborder="0" allowfullscreen></iframe>');
